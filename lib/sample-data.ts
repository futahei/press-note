...
const commonTerms: Term[] = [
  {
    term: "MLOps",
    description: "機械学習モデルの開発、運用、監視を継続的に回すための実践体系である。品質劣化の検知や再学習の自動化に使われる。"
  },
  {
    term: "デジタルツイン",
    description: "現実の設備や工程を仮想空間に再現し、シミュレーションや分析を行う技術である。製造業の保全や生産計画で活用される。"
  },
  {
    term: "ゼロトラスト",
    description: "社内外を問わず全てのアクセスを検証するセキュリティの考え方である。クラウド利用やリモートワークの普及で重要度が高まった。"
  }
];
...
export const articles: Article[] = [
  ...
  },
  {
    ...
    terms: [
      {
        term: "協働ロボット",
        description: "人と同じ空間で作業することを前提に設計されたロボットである。安全機能により製造や物流の省人化に使われる。"
      }
    ],
  ...
  },
  {
    ...
    terms: [
      {
        term: "遺伝子編集",
        description: "DNA配列を狙った位置で改変する技術である。疾患原因となる遺伝子の修正や研究用途で利用される。"
      }
    ],
  ...
  },
  {
    ...
    terms: [
      {
        term: "AI-OCR",
        description: "AIを用いて紙や画像内の文字を読み取る技術である。請求書や領収書の入力作業を削減する用途で使われる。"
      }
    ],
